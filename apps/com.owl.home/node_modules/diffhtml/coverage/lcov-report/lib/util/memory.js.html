...
<html lang="en">
<head>
    <title>Code coverage report for lib/util/memory.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/util</a> memory.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">631x</span>
<span class="cline-any cline-yes">11036x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Pool from './pool';
...
export function unprotectVTree(vTree) {
  unprotect(vTree);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ReleaseHookCache.size) {
<span class="cstat-no" title="statement not covered" >    ReleaseHookCache.forEach(<span class="fstat-no" title="function not covered" >fn</span> =&gt; <span class="cstat-no" title="statement not covered" >fn(vTree))</span>;</span>
  }
&nbsp;
  for (let i = 0; i &lt; vTree.childNodes.length; i++) {
