...
<html lang="en">
<head>
    <title>Code coverage report for lib/tree/create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/tree</a> create.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.58% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>87/95</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11889x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11881x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11775x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11775x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11569x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11376x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11186x</span>
<span class="cline-any cline-yes">369x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">10817x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">10816x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11186x</span>
<span class="cline-any cline-yes">11186x</span>
...
<span class="cline-any cline-yes">11186x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { NodeCache, MiddlewareCache } from '../util/caches';
...
&nbsp;
  ...
  if (isObject) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if ('children' in input &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!('childNodes' in input))</span> {
      const nodeName = <span class="cstat-no" title="statement not covered" >input.nodeName || input.elementName;</span>
<span class="cstat-no" title="statement not covered" >      return createTree(nodeName, input.attributes, input.children);</span>
    }
&nbsp;
    return input;
  }
...
&nbsp;
      // Merge in arrays.
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isNodeArray) {
<span class="cstat-no" title="statement not covered" >        for (let i = 0; i &lt; newNode.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >          entry.childNodes.push(newNode[i]);</span>
        }
      }
      ...
      // Merge in fragments.
      else <span class="missing-if-branch" title="if path not taken" >I</span>if (newNode.nodeType === 11 &amp;&amp; typeof newNode.rawNodeName === 'string') {
<span class="cstat-no" title="statement not covered" >        for (let i = 0; i &lt; newNode.childNodes.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >          entry.childNodes.push(newNode.childNodes[i]);</span>
        }
      }
      ...
      // node from appearing.
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (newNode) {
...
&nbsp;
  let vTree = entry;
&nbsp;
  CreateTreeHookCache.forEach(<span class="fstat-no" title="function not covered" >(f</span>n, retVal) =&gt; {
...
<span class="cstat-no" title="statement not covered" >    if (retVal = fn(vTree)) {</span>
<span class="cstat-no" title="statement not covered" >      vTree = retVal;</span>
    }
  });
&nbsp;
  return vTree;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Jul 02 2018 19:52:03 GMT-0700 (Pacific Daylight Time)
</div>
</div>
