...
<html lang="en">
<head>
    <title>Code coverage report for lib/node/create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/node</a> create.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  if (existingNode) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (existingNode.nodeName.toLowerCase() !== vTree.nodeName) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Shit is wrong');</span>
    }
&nbsp;
    return existingNode;
  }
...
&nbsp;
  ...
  let domNode = null;
&nbsp;
  CreateNodeHookCache.forEach(<span class="fstat-no" title="function not covered" >(f</span>n, retVal) =&gt; {
...
<span class="cstat-no" title="statement not covered" >      domNode = retVal;</span>
    }
  });
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!domNode) {
