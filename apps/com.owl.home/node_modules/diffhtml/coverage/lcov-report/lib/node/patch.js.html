...
<html lang="en">
<head>
    <title>Code coverage report for lib/node/patch.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/node</a> patch.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.03% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>126/134</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">141x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import createNode from './create';
...
&nbsp;
  ...
  else <span class="missing-if-branch" title="else path not taken" >E</span>if (!blacklist.has(blacklistName)) {
    try {
      domNode[name] = undefined;
      whitelist.add(blacklistName);
    } catch (unhandledException) {
<span class="cstat-no" title="statement not covered" >      blacklist.add(blacklistName);</span>
    }
  }
};
&nbsp;
...
&nbsp;
        ...
        domNode.setAttribute(name, noValue ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: value);
      }
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (whitelist.has(blacklistName)) {
<span class="cstat-no" title="statement not covered" >          domNode[name] = value;</span>
        }
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (!blacklist.has(blacklistName)) {
          try {
            domNode[name] = value;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (newPromises.length) {
<span class="cstat-no" title="statement not covered" >        Promise.all(newPromises).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >removeAttribute(domNode, name))</span>;</span>
<span class="cstat-no" title="statement not covered" >        promises.push(...newPromises);</span>
      }
      else {
...
&nbsp;
        const domNode = NodeCache.get(vTree);
        const refNode = refTree &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >createNode(refTree, ownerDocument, isSVG);</span>
        const attached = TransitionCache.get('attached');
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (refTree) {
<span class="cstat-no" title="statement not covered" >          protectVTree(refTree);</span>
        }
&nbsp;
