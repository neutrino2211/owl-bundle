...
<html lang="en">
<head>
    <title>Code coverage report for lib/tasks/schedule.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/tasks</a> schedule.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">138x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Transaction from '../transaction';
...
&nbsp;
    ...
    transaction.abort();
&nbsp;
    const promise = chainTransaction.promise || <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve();</span>
&nbsp;
