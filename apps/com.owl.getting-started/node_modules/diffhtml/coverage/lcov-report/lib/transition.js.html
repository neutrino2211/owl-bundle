...
<html lang="en">
<head>
    <title>Code coverage report for lib/transition.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> transition.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">34x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { TransitionCache } from './util/caches';
...
&nbsp;
    [...element.childNodes].forEach(<span class="fstat-no" title="function not covered" >ch</span>ildNode =&gt; {
<span class="cstat-no" title="statement not covered" >      promises.push(...runTransitions(setName, childNode, ...args.slice(1)));</span>
    });
  }
&nbsp;
  return promises;
