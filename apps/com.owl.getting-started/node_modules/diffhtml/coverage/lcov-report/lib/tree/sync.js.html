...
<html lang="en">
<head>
    <title>Code coverage report for lib/tree/sync.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/tree</a> sync.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>138/140</span>
      </div>
    </div>
    <p class="quiet">
...
&nbsp;
    ...
    else <span class="missing-if-branch" title="if path not taken" >I</span>if (retVal &amp;&amp; retVal !== newTree) {
      // Synchronize this new tree.
<span class="cstat-no" title="statement not covered" >      newTree = retVal;</span>
    }
  });
&nbsp;
  if (shortCircuit) {
...
&nbsp;
  ...
  // FIXME
  if (process.env.NODE_ENV !== 'production') {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isEmpty &amp;&amp; oldNodeName !== newNodeName &amp;&amp; !isFragment) {
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (newKey) {
...
&nbsp;
      ...
      if (!oldChildNode) {
        INSERT_BEFORE.push(oldTree, newChildNode, null);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (oldChildNodes) {
          oldChildNodes.push(newChildNode);
        }
&nbsp;
