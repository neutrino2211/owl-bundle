...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import createTree from './tree/create';
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof devTools !== 'undefined') {
<span class="cstat-no" title="statement not covered" >  use(devTools(Internals));</span>
<span class="cstat-no" title="statement not covered" >  console.warn('diffHTML DevTools: Found and Activated...');</span>
}
&nbsp;
export {
  VERSION,
